    ...
    <div style={{
      ...
      <nav className="navbar bg-dark ">
        <div className="container-fluid justify-end ">
          <span className="navbar-brand mb-0 h1 text-white justify-content-start ">Bitcoin Converter</span>
          <span className='d-flex'>
          <button className='' onClick={conversionHandler} >View Conversions</button>
          
            <div className="dropdown ms-5">
            
              <button className="btn btn-dark dropdown-toggle shadow-lg" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                Currency Converter
              </button>
      ...
      <CurrentTime localTime={localTime} setLocalTime={setLocalTime} dataTime={dataTime} setDataTime={setDataTime} fetchAPI={fetchAPIData} fetchTime={fetchTime} setFetchTime={setFetchTime}></CurrentTime>
      </div>
      </div>
    </div>
  )
